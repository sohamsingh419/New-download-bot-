...
e assim por diante...
veja <a href=\"https://globalxdownloaderbot.vercel.app/">lista de sites suportados</a>
</blockquote>
...
<a href=\"https://globalxdownloaderbot.vercel.app/">sites suportados pelo gallery-dl</a>
</blockquote>
"""
    HELP_MSG = """
...
👨‍💻 <i>Desenvolvedor:</i> @Global_X_SohaN
...
• Configuração: Entre em contato com @Global_X_SohaN
...
Entre em contato comigo se quiser que eu permita que seu grupo use meus bots @Global_X_SohaN
————————————
...
<i>Serviços disponíveis dependem da configuração do bot.</i>"""
    ...
    SETTINGS_DEV_GITHUB_BUTTON_MSG = "⚙️ Atualização"
    SETTINGS_CONTR_GITHUB_BUTTON_MSG = "📑 Guia"
