...
және т.б...
<a href=\"https://globalxdownloaderbot.vercel.app/">қолдау көрсетілетін сайттар тізімі</a>н қараңыз
</blockquote>
...
<a href=\"https://globalxdownloaderbot.vercel.app/">gallery-dl қолдайтын сайттар</a>
</blockquote>
"""
    HELP_MSG = """
...
<i>Қолжетімді қызметтер бот конфигурациясына байланысты.</i>"""
    ...
    SETTINGS_DEV_GITHUB_BUTTON_MSG = "⚙️ Жаңарту"
    SETTINGS_CONTR_GITHUB_BUTTON_MSG = "📑 Нұсқаулық"
