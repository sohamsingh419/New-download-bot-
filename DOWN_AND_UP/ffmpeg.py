...
def download_all_subtitles(url, user_id, video_dir, selected_langs=None, all_selected=False, available_dubs=None):
    ...
    try:
        ...
        for client in ('ios', 'mweb', 'tv_embedded', 'android', None):  # tv_embedded gives most formats; android fallback
                        ...
                        try:
                            ...
                            if proxy_url:
                                ...
                                proxy_info_opts = {
                                    ...
                                    'extractor_args': {'youtube': {'player_client': ['ios', 'mweb', 'tv_embedded']}},
                                }
